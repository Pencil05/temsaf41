...
export default async function MyItemsPage() {
  ...
  const [history, actions, borrowData] = await Promise.all([getUserTransactionHistory(user), getDashboardActionData(user), getBorrowPageData(user)]);
  return <MyItemsClient history={history} returns={actions.returns} inventory={borrowData.inventory} />;
}
